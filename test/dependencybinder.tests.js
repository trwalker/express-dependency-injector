...
describe('DependencyBinder Tests', function() {
  ...
  describe('bind()', function() {
    ...
    it('should throw on null scope', function() {
      ...
      expect(bindFunction.bind(dependencyBinder, MyClass, [MyDependency], scope)).to.throw('Dependency scope cannot be null or undefined. Valid scope types are "signleton", "webrequest", and "transient".');
    });
    ...
    it('should throw on bad scope', function() {
      ...
      expect(bindFunction.bind(dependencyBinder, MyClass, [MyDependency], scope)).to.throw('Invalid dependency scope. Valid scope types are "signleton", "webrequest", and "transient".');
    });
  ...
  describe('get()', function() {
    ...
    it('should throw on null scope', function() {
      ...
      expect(getFunction.bind(dependencyBinder, scope)).to.throw('Dependency scope cannot be null or undefined. Valid scope types are "signleton", "webrequest", and "transient".');
    });
    ...
    it('should throw on bad scope', function() {
      ...
      expect(getFunction.bind(dependencyBinder, scope)).to.throw('Invalid dependency scope. Valid scope types are "signleton", "webrequest", and "transient".');
    });
